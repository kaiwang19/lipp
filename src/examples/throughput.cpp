 ...
 * --init_num_keys          number of keys to bulk load with                                                                                                                                                 number of keys to bulk load with
...
int main(int argc, char *argv[])
{
    ...
    auto time_limit = stod(get_with_default(flags, "time_limit", "0.5")); // 30 seconds in total
    ...
    while (true)
    {
        ...
        // Check for workload end conditions - this batch does no inserts
