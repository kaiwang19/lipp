...
--lookup_distribution=zipf \
--time_limit=1 \
--print_batch_stats > ./reports/longititude_zipf_100M_200M_10M_0.33.txt
...
--lookup_distribution=zipf \
--time_limit=1 \
--print_batch_stats > ./reports/longititude_zipf_100M_200M_10M_0.67.txt
...
--lookup_distribution=zipf \
--time_limit=1 \
--print_batch_stats > ./reports/longlat_zipf_100M_200M_10M_0.33.txt
...
--lookup_distribution=zipf \
--time_limit=1 \
--print_batch_stats > ./reports/longlat_zipf_100M_200M_10M_0.67.txt
...
--lookup_distribution=zipf \
--time_limit=1 \
--print_batch_stats > ./reports/lognormal_zipf_100M_190M_10M_0.33.txt
...
--lookup_distribution=zipf \
--time_limit=1 \
--print_batch_stats > ./reports/lognormal_zipf_100M_190M_10M_0.67.txt
