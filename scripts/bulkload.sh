...
--batch_size=1000 \
--print_batch_stats > ./reports/bulkload/longititude_100M.txt
...
--total_num_keys=100000000 \
--batch_size=10000000 \
--print_batch_stats > ./reports/bulkload/longlat_100M.txt
...
--total_num_keys=100000000 \
--batch_size=10000000 \
--print_batch_stats > ./reports/bulkload/lognormal_100M.txt
...
--total_num_keys=100000000 \
--batch_size=10000000 \
--print_batch_stats > ./reports/bulkload/ycsb_100M.txt
